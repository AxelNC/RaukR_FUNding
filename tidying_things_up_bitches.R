...
################################################################################
#### get/summarize yearly funding per university and keep code
...
all_university_funding_yearly <- all_university_projects %>% group_by(CoordinatingOrganisationNameSv, FundingYear) %>%
  summarize(
